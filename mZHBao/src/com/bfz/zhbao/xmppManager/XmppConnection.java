package com.bfz.zhbao.xmppManager;
...
public class XmppConnection {
	...
	//设置openfire的服务器名
	public static String SERVER_NAME = "langbao";
	//服务器地址和端口 
	//public static String SERVER_HOST = "zhaohuobao.bfz";
	//public static String SERVER_HOST = "61.185.145.244";
	public static String SERVER_HOST = "192.168.1.32";
